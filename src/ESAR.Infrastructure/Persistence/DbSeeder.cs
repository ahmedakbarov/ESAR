...
public static class DbSeeder
{
    ...
    private static async Task SeedMatchingRulesAsync(EsarDbContext db, CancellationToken ct)
    {
        ...
        var rules = new (string Name, string Attr, MatchType Type, decimal Weight, int Order)[]
        {
            ...
            ("AD Computer Object GUID", MatchAttributes.AdComputerObjectGuid, MatchType.Hard, 1.00m, 60),
            ("Entra Device ID", MatchAttributes.EntraDeviceId, MatchType.Hard, 1.00m, 61),
            ("Azure VM ID", MatchAttributes.AzureVmId, MatchType.Hard, 1.00m, 62),
            ("Defender Machine ID", MatchAttributes.DefenderMachineId, MatchType.Hard, 1.00m, 70),
            ("CrowdStrike Device ID", MatchAttributes.CrowdStrikeDeviceId, MatchType.Hard, 1.00m, 71),
            ("SentinelOne Agent ID", MatchAttributes.SentinelOneAgentId, MatchType.Hard, 1.00m, 72),
            ("Cortex Endpoint ID", MatchAttributes.CortexEndpointId, MatchType.Hard, 1.00m, 73),
