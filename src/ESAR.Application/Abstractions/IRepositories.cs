...
public interface IUnitOfWork
{
    ...
    /// <summary>Detaches every tracked entity — recovery hatch after a failed SaveChanges
    /// so one poisoned aggregate cannot break subsequent saves in the same scope.</summary>
